package suncodes.aspectj.aopconfig.advisor;
...
public class LogAdvisor extends DefaultPointcutAdvisor {
    public LogAdvisor() {
        ...
        pointcut.setExpression("execution(* suncodes.aspectj.aopconfig.targets.*.*(..))");
        super.setPointcut(pointcut);
        super.setAdvice(new MethodBeforeAdvice() {
            @Override
            public void before(Method method, Object[] objects, Object o) throws Throwable {
                log.info("aop:config LogAdvisor MethodBeforeAdvice");
            }
        });
    }
}
